...
namespace NerdStore.Catalogo.Application.Services
{
    public class ProdutoAppService : IProdutoAppService
    {
        ...
        public async Task<IEnumerable<CategoriaViewModel>> ObterCategorias() => _mapper
            .Map<IEnumerable<CategoriaViewModel>>(await _produtoRepository.ObterCategorias());

        public async Task<IEnumerable<ProdutoViewModel>> ObterPorCategoria( int codigo ) => _mapper
            .Map<IEnumerable<ProdutoViewModel>>(await _produtoRepository.ObterPorCategoria(codigo));

        public async Task<ProdutoViewModel> ObterPorId( Guid id ) => _mapper
            .Map<ProdutoViewModel>(await _produtoRepository.ObterPorId(id));

        public async Task<IEnumerable<ProdutoViewModel>> ObterTodos() => _mapper
